...
List<Disponibilidade> criarDisponibilidadesSerie(
  ...
  switch (tipo) {
    case 'Única':
      {
        // CORREÇÃO: Gerar ID mais robusto para disponibilidades únicas
        // Usar formato que será facilmente identificável como temporário
        // para que possa ser substituído por um ID permanente antes de salvar
        final timestamp = DateTime.now().microsecondsSinceEpoch;
        final dataStr =
            '${dataInicial.year}${dataInicial.month.toString().padLeft(2, '0')}${dataInicial.day.toString().padLeft(2, '0')}';
        // ID temporário que será substituído por um ID permanente antes de salvar
        final uniqueId = 'temp_${timestamp}_${medicoId}_$dataStr';
        lista.add(
          Disponibilidade(
            id: uniqueId,
